...
<body>
 ...
 -->
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<div class="input-group">
						<input type="text" class="form-control" name="account_email1" maxlength="20" placeholder="Enter E-mail" aria-label="Amount (to the nearest dollar)"  aria-describedby="basic-addon2">
						<span class="input-group-addon" id="basic-addon2">@</span>
						<select type="button" class="form-control btn btn-default dropdown-toggle" data-toggle="dropdown" aria-expanded="false" name="account_email2">
